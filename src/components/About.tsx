...
export default function About() {
    ...
    return (
        <section
            ref={sectionRef}
            id="about"
            className={`min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-20 transition-opacity duration-1000 ${isVisible ? 'animate-fadeInUp' : 'opacity-0'
                }`}
        >
            <div className="container mx-auto px-6 lg:px-8">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className={`text-center mb-16 transition-all duration-700 delay-200 ${isVisible ? 'animate-slideInDown' : 'opacity-0 -translate-y-10'
                        ...
                        <div className="inline-flex items-center px-4 py-2 bg-purple-500/10 border border-purple-500/20 rounded-full text-purple-400 text-sm font-medium mb-8 backdrop-blur-sm animate-pulse-glow">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className={`space-y-8 transition-all duration-700 delay-400 ${isVisible ? 'animate-slideInLeft' : 'opacity-0 -translate-x-10'
                            ...
                            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 hover:animate-hoverFloat transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {[
                                        ...
                                        >
                                            ...
                                            <span className="text-slate-300 font-medium hover:text-white transition-colors duration-200">{skill.name}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        <div className={`space-y-8 transition-all duration-700 delay-600 ${isVisible ? 'animate-slideInRight' : 'opacity-0 translate-x-10'
                            ...
                            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 hover:animate-hoverFloat transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20">
                                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                                ...
                                <div className="space-y-4">
                                    {[
                                        ...
                                        >
                                            ...
                                            <div>
                                                <h4 className="text-white font-semibold mb-1 hover:animate-textGlow">{step.title}</h4>
